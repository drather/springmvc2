...
//            bindingResult.addError(new FieldError("item", "price", "1,000원 이상, 1,000,000원 이하의 가격만 입력 가능합니다. "));
//        }
//
...
//            return "validation/v2/addForm"; // 입력을 그대로 뷰 템플릿으로 보냄
//        }
//
//        // 성공 로직
...
//    @PostMapping("/add")
    public String addItemV3(@ModelAttribute Item item, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
        // bindingResult 는 이미 검증할 대상을 알고 있다.
